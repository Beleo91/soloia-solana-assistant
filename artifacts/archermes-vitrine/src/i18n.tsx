...
const translations = {
  en: {
    ...
    'purchases.confirmBtn': '✓ Confirm Receipt & Release Payment',
    'purchases.confirming': 'Releasing funds...',
    'purchases.confirmed': '✓ Confirmed',
    'purchases.delivered': '✓ Delivered',
    'purchases.shipped': '📦 Shipped',
    'purchases.refunded': '↩ Refunded',
    'purchases.pending': 'Awaiting shipment',
    'purchases.loading': 'Loading purchases...',
    'purchases.dispute': 'Problem with your order? Contact support:',
    'purchases.show': '🛍 My Purchases',
    'purchases.hide': 'Hide',
    'purchases.trackingCode': 'Tracking Code',
    'purchases.waitingShipment': 'Waiting for seller to ship your order.',
    'purchases.paymentReleased': 'Payment released to seller. Order complete!',
  ...
  pt: {
    ...
    'purchases.confirmBtn': '✓ Confirmar Recebimento e Liberar Pagamento',
    'purchases.confirming': 'Liberando fundos...',
    'purchases.confirmed': '✓ Confirmado',
    'purchases.delivered': '✓ Entregue',
    'purchases.shipped': '📦 Enviado',
    'purchases.refunded': '↩ Reembolsado',
    'purchases.pending': 'Aguardando envio',
    ...
    'purchases.trackingCode': 'Código de Rastreio',
    'purchases.waitingShipment': 'Aguardando o vendedor enviar o produto.',
    'purchases.paymentReleased': 'Pagamento liberado ao vendedor. Pedido concluído!',
