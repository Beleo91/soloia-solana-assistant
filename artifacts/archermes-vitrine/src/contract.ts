...
export const CONTRACT_ABI = [
  ...
  {
    inputs: [{ internalType: 'string', name: '_itemName', type: 'string' }, { internalType: 'uint256', name: '_price', type: 'uint256' }, { internalType: 'string', name: '_category', type: 'string' }],
  ...
  { inputs: [{ internalType: 'uint256', name: '_newPlatformPercent', type: 'uint256' }, { internalType: 'uint256', name: '_newReferralPercent', type: 'uint256' }], name: 'setFeePercentages', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  { inputs: [{ internalType: 'uint256', name: '_newBasicFee', type: 'uint256' }, { internalType: 'uint256', name: '_newProFee', type: 'uint256' }], name: 'setStoreFees', outputs: [], stateMutability: 'nonpayable', type: 'function' },
